...
$.validator.addMethod("isEmail", function(value, element) {
	var stringAndNum=/^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$/;
...
$.validator.addMethod("isBankAccount", function(value, element) {
	var stringAndNum=/^([1-9]{1})(\d{14}|\d{18})$/;
	return this.optional(element) || stringAndNum.test(value);
}, "银行卡格式错误");
 ...
 * 邮箱验证
 */
$.validator.addMethod("isEmile", function(value, element) {
...
//0-100的数字
$.validator.addMethod("isOneToOneHundred", function(value, element) {
	var stringAndNum=/^100$|^(\d|[1-9]\d)$/;//无小数
	//var stringAndNum=/^100$|^(\d|[1-9]\d)(\.\d+)*$/;//有小数
    return this.optional(element) || stringAndNum.test(value);
}, "权重格式错误");

//金额（投标中保证金，合同中金额）
$.validator.addMethod("isDeposit", function(value, element) {
	var stringAndNum=/^[0-9]*$/;
	return this.optional(element) || stringAndNum.test(value);
}, "金额格式错误");
