...
<%@page import="com.mossle.common.ProcessInstanceDiagramCmd"%>
...
<%
	...
	if (businessKey != null) {
		ProcessInstance processInstance = processEngine.getRuntimeService().createProcessInstanceQuery().processInstanceBusinessKey(businessKey).singleResult();
		cmd = new ProcessInstanceDiagramCmd(processInstance.getId());
	}
